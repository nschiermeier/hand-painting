...
import numpy as np
from os.path import abspath # unused, can maybe be deleted?
...
for frame in webcam:
    ...
    if results.multi_hand_landmarks: # Only execute this if a hand is detected in webcam
      for hand_landmark in results.multi_hand_landmarks:
        ...
        print(f"Index  tip coord: ({index_tip_x:.3f}, {index_tip_y:.3f})")
        print(f"Middle tip coord: ({middle_tip_x:.3f}, {middle_tip_y:.3f})")
